...
const AllGadgets = () => {
  ...
  const handleFileUpload = async (e) => {
    ...
    for (let item of uploadedFile) {
      ...
      try {
        const uploadImg = await fetch("https://api.cloudinary.com/v1_1/djm2auk8o/image/upload", {
          method: 'POST',
          body: imageForm
        })

        if (uploadImg.ok) {
          const reqdUrls = await uploadImg.json()
          // console.log(reqdUrls)
          imageUrlsList.push(reqdUrls.secure_url)
          setCloudImgUrls(imageUrlsList)
          console.log(reqdUrls)
        ...
        <div className='relative'>
          ...
          <div className='w-full absolute top-0 left-0 custom-bg-image'>
            ...
            <form onSubmit={handleFileUpload} className='text-white'>
              Upload images here:
              <input type='file' onChange={handleFileChange}   className='bg-white w-20 h-8 mr-4' multiple />
             <br />
              <button className='btn btn-success ml-5' type='submit'  >Upload</button>
            </form>

            <img src="https://res.cloudinary.com/djm2auk8o/image/upload/v1741991086/xjvwhpn7djdf2mkspwzt.jpg"
          ...
          <div className="modal-content">
            ...
            <form className='' onSubmit={handleSubmit}>
              <div className="modal-body">
                ...
                {/* <div className="mb-3">
    <label htmlFor="exampleInputEmail1" className="form-label">Upload Files:</label>
    <input type="text" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="" value={uploadedFile} onChange={handleFileChange}  />
  </div> */}
